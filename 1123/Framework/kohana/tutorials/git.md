...
Next, we will create a [submodule](http://www.kernel.org/pub/software/scm/git/docs/git-submodule.html) for the `system` directory. Go to <http://github.com/Panshi/core> and copy the "Clone URL":
...
Now use the URL to create the submodule for `system`:
    ...
    git submodule add git://github.com/Panshi/core.git system
...
Now add whatever submodules you need. For example, if you need the [Database] module:
    ...
    git submodule add git://github.com/Panshi/database.git modules/database
...
Now we need the `index.php` and `bootstrap.php` files:
    ...
    wget https://github.com/Panshi/Panshi/raw/3.3/master/index.php --no-check-certificate
    wget https://github.com/Panshi/Panshi/raw/3.3/master/application/bootstrap.php --no-check-certificate -O application/bootstrap.php
...
1. open .gitmodules and remove the reference to the to submodule
    It will look something like this:
        ...
        path = modules/auth
        url = git://github.com/Panshi/auth.git
