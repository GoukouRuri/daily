...
Panshi provides a very simple way to display statistics about your application:

1. Common [Panshi] method calls, such as [Panshi::find_file()].
2. Requests. Including the main request, as well as any sub-requests.
3. [Database] queries
4. Average execution times for your application

[!!]  In order for profiling to work, the `profile` setting must be `TRUE` in your [Panshi::init()] call in your bootstrap.
