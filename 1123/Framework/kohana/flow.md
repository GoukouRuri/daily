...
2. Once we are in `bootstrap.php`:
	6. The [Panshi] class is loaded.
	7. [Panshi::init] is called, which sets up error handling, caching, and logging.
	8. [Panshi_Config] readers and [Panshi_Log] writers are attached.
	9. [Panshi::modules] is called to enable additional modules.
