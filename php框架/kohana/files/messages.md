...
Panshi has a robust key based lookup system so you can define system messages.

## Getting a message

Use the Panshi::message() method to get a message key:

	Panshi::message('forms', 'foobar');
...
You can also look in subfolders and sub-keys:
	...
	Panshi::message('forms/contact', 'foobar.bar');
